...
var CSVToArray = function CSVToArray(CSV_string, delimiter) {
...
/* harmony default export */ const CSVtoJSON = (CSVToArray);
...
function App() {
  ...
  var _useState3 = (0,react.useState)(false),
      ...
      selectedContainer = _useState4[0],
      setSelectedContainer = _useState4[1];

  (0,react.useEffect)(function () {}, [dataContent]);
  (0,react.useEffect)(function () {
    var getDataPath = function getDataPath() {
      if (window.location.href.includes("github")) return "./assets/data/data.csv";
      if (true) return "https://lusi-dataviz.ylestatic.fi/2022-10-sahkokatkot/assets/data/data.csv";else {}
    };
    ...
    try {
      fetch(getDataPath()).then(function (response) {
        ...
        return setContentData(CSVtoJSON(body));
      });
    } catch (error) {
      console.error(error);
    }
  ...
  var changeSelection = function changeSelection(event, i) {
    setSelectedContainer(i);

    if (selectedContainer !== false) {
      document.querySelectorAll(".content_container").forEach(function (el) {
    ...
    for (var idx = 0; idx <= 2; idx++) {
      if (idx === i) {
        document.querySelector(".content_container_".concat(i)).classList.add("center");
        document.querySelector(".content_container_".concat(i)).classList.remove("left");
        document.querySelector(".content_container_".concat(i)).classList.remove("right");
      } else if (idx < i) {
        document.querySelector(".content_container_".concat(idx)).classList.add("left");
        document.querySelector(".content_container_".concat(idx)).classList.remove("center");
        document.querySelector(".content_container_".concat(idx)).classList.remove("right");
      } else if (idx > i) {
        document.querySelector(".content_container_".concat(idx)).classList.add("right");
        document.querySelector(".content_container_".concat(idx)).classList.remove("center");
        document.querySelector(".content_container_".concat(idx)).classList.remove("left");
      }
    }
    ...
    if (selectedContainer === false) {
      helpers_slideToggle(document.querySelectorAll(".content_container")[i]);
    }
  };
  ...
  return /*#__PURE__*/react.createElement("div", {
    ...
    className: "container"
  }, /*#__PURE__*/react.createElement("h3", null, "Valitse, ket\xE4 haluat seurata"), /*#__PURE__*/react.createElement("div", {
    className: "selection_containers"
  }, dataContent && dataContent[0].map(function (column, i) {
    return /*#__PURE__*/react.createElement("div", {
      key: column,
      className: "selection_container selection_container_".concat(i, " ").concat(selectedContainer !== i && selectedContainer !== false ? "not_selected" : "")
    }, /*#__PURE__*/react.createElement("button", {
      type: "button",
      onClick: function onClick(event) {
        return changeSelection(event, i);
      }
    }, column));
  })), /*#__PURE__*/react.createElement("div", {
    className: "content_containers"
  }, dataContent && dataContent[0].map(function (column, i) {
    return /*#__PURE__*/react.createElement("div", {
      key: column,
      className: "content_container content_container_".concat(i)
    }, dataContent && _toConsumableArray(dataContent).slice(1).map(function (row) {
      return /*#__PURE__*/react.createElement("div", {
        key: row,
        ...
        paragraph = paragraph.replace(/Katuvalot ja liikennevalot sammuvat, lähes kaikki huoltoasemat menevät kiinni./, "<strong>Katuvalot ja liikennevalot</strong> sammuvat, lähes kaikki <strong>huoltoasemat</strong> menevät kiinni.");
        paragraph = paragraph.replace(/Emma yllättyy, kun lähellä oleva huoltoasema on auki. Se on yksi Suomen muutamasta kymmenestä huoltoasemasta, joilla on varavoimaa käytössään. Emma saa tankin täyteen./, 'Emma yllättyy, kun lähellä oleva huoltoasema on auki. Se on yksi Suomen <a href="https://yle.fi/uutiset/3-12535915" target="_blank">muutamasta kymmenestä huoltoasemasta</a>, joilla on varavoimaa käytössään. Emma saa tankin täyteen.'); // eslint-disable-next-line
...
var appName = "2022-10-sahkokatkot";

var getContainer = function getContainer() {
  return document.getElementById('app-root-' + appName);
};

var startApp = function startApp(parameters) {
  if (!getContainer()) {
